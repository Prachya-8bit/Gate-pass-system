...
**EPRO บังคับว่าเวลาเริ่มต้องห่างจากตอนกด Save อย่างน้อย 1 ชั่วโมง** ซึ่งวัดตอน **RPA กด Save** ไม่ใช่ตอนผู้รับเหมากรอก ระหว่างนั้นมี admin ยืนยัน (นานเท่าไหร่ก็ได้) + cron 10 นาที ผลคือใบที่ขอชิดขั้นต่ำจะถูก EPRO ปฏิเสธได้ **และ retry ยิ่งแย่ลงเพราะเวลาเดินหน้า**
